...
public interface AllTypesService {
    ...
    /**
	 * Find and return the AllTypes for given floatCol  if exists.
	 *
	 * @param floatCol value of floatCol; value cannot be null.
	 * @return AllTypes associated with the given inputs.
     * @throws EntityNotFoundException if no matching AllTypes found.
	 */
    AllTypes getByFloatCol(Float floatCol)throws EntityNotFoundException;
